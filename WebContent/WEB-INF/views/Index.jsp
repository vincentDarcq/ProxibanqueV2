      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Que Voulez-vous faire ?</h2>
        ...
        <div class="row text-center">
          ...
          <div class="col-md-4">
            ...
            <a class="btn btn-primary btn-xl service-heading text-uppercase js-scroll-trigger" href="#portfolio">Effectuer un Virement</a>
            <p class="text-muted">Pour un client spécifique</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fas fa-circle fa-stack-2x text-primary"></i>
              <i class="fas far fa-address-book fa-stack-1x fa-inverse"></i>
            </span>
            <a class="btn btn-primary btn-xl service-heading text-uppercase js-scroll-trigger" href="#portfolio">Consulter mes Clients</a>
            <p class="text-muted">Consulter votre liste ci-dessous</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Voici vos Clients au sein de l'agence</h3>
          </div>
        </div>
        <div class="row">
          <c:forEach var="client" items="${clients}">
          	<div class="col-md-4 col-sm-6 portfolio-item">
            	...
            	<div class="portfolio-caption">
              		...
              		<h5 class="text-muted">${client.address}</h5>
    ...
    <section class="bg-light" id="team">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="img/team/v.PNG" alt="">
              <h4>Vincent DARCQ</h4>
          ...
          <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="img/team/b.PNG" alt="">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">N'espérez pas une réponse étant donné un SAV innexistant</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <form id="contactForm" name="sentMessage" novalidate="novalidate">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input class="form-control" id="phone" type="tel" placeholder="Votre n° de téléphone *" required="required" data-validation-required-message="Please enter your phone number.">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
                <div class="col-md-6">
